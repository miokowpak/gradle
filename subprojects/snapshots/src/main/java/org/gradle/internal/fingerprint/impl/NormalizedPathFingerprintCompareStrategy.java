...
public class NormalizedPathFingerprintCompareStrategy extends AbstractFingerprintCompareStrategy {
     ...
     *     </li>
     *     <li>Finally, {@code shouldIncludeAdded} is always {@code true}, meaning that the remaining fingerprints which are only in the current collection are reported as added.</li>
     * </ul>
     */
    @Override
